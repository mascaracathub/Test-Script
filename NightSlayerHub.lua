...
task.wait(3)
Notification.new("<Color=Blue>Night Slayer Hub yêu Bác Hồ<Color=/>"):Display()
task.wait(3)
...
_G.imageLogo = "rbxassetid://130627959945"
_G.Logo = "rbxassetid://130627959945"
_G.NameHub = "tiktok.com/@tirohub"
_G.Title = "Night Slayer Hub"
-----------------------------------------------------------------
...
ImageButton.Image = "rbxassetid://130627959945"
	...
	coroutine.resume(
		coroutine.create(
			function()
				...
				Circle.ZIndex = 10
				Circle.Image = "rbxassetid://130627959945"
...
Disc_Logo.Image = "http://www.roblox.com/asset/?id=130627959945"
...
UICorner.Parent = ImageButton
	...
	function tabs:Tab(Name, icon)
		...
		ImageLabel.Image = "http://www.roblox.com/asset/?id=130627959945" .. icon
	   ...
	   Sep2.TextXAlignment = Enum.TextXAlignment.Center
		...
		function functionitem:Button(Name, callback)
			...
			function functionitem:Toggle(Name, default, callback)
				...
				MainToggle_3.Image = "http://www.roblox.com/asset/?id=130627959945"
			...
			function functionitem:Dropdown(Name, list, default, callback)
				...
				ImageButton.Image = "http://www.roblox.com/asset/?id=130627959945"
    ...
    while wait() do
     ...
     FM = Trailers:Label("Full Moon")
        ...
        task.spawn(function()
            while task.wait() do
                pcall(function()
                    if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=130627959945" then
                        FM:Set("Full Moon: 100")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=130627959945" then
                        FM:Set("Full Moon: 75")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=130627959945" then
                        FM:Set("Full Moon: 50")
                    elseif game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/asset/?id=130627959945" then
