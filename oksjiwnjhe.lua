...
-- WEBHOOK
local reportWebhookURL = "https://discord.com/api/webhooks/1470044802107183176/qhTvU94722zc25k_bFCHJWXkXZgJwdrda3bkNmuZUFZN3wCYntZPBU0s98S2gW8UYBRS"
local ideasWebhookURL = "https://discord.com/api/webhooks/1470044802107183176/qhTvU94722zc25k_bFCHJWXkXZgJwdrda3bkNmuZUFZN3wCYntZPBU0s98S2gW8UYBRS"
...
local Window = Fluent:CreateWindow({
    Title = "Night Slayer Hub Hub Main",
    SubTitle = "by discord_betaa ",
    TabWidth = 160,
...
Tabs.Info:CreateSection("Link Night Slayer Hub Hub")

Tabs.Info:CreateButton{
    Title = "Get Link Night Slayer Hub",
    Description = "",
    Callback = function()
        Window:Dialog{
            Title = "Night Slayer Hub Hub",
            ...
            Buttons = {
                ...
                },
                {
                    Title = "TikTok",
                    Callback = function()
                        setclipboard("https://www.tiktok.com/@discord_betaa")
                    end
                },
                {
                    Title = "Cancel",
            ...
            Buttons = {
                {
                    ...
                    Callback = function()
                        ...
                        -- Tạo embed data
                        local data = {
                            ["username"] = "Night Slayer Hub Hub Reporter",
                            ...
                            ["embeds"] = {{
                                ...
                                ["footer"] = {
                                    ["text"] = "Night Slayer Hub Hub • " .. time,
