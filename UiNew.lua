...
local redzlib = {
    Themes = {
        ...
        DenXanh = {
            ["Color Hub 1"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 30, 50)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 12, 20))
            }),
            ["Color Hub 2"] = Color3.fromRGB(10, 15, 25),
            ["Color Stroke"] = Color3.fromRGB(30, 45, 70),
            ["Color Theme"] = Color3.fromRGB(40, 100, 200),
            ["Color Text"] = Color3.fromRGB(230, 240, 255),
            ["Color Dark Text"] = Color3.fromRGB(150, 180, 210)
        },
        
        -- Theme đen trắng hoàn toàn
        DenTuyetDoi = {
            ["Color Hub 1"] = ColorSequence.new({
        ...
        DenDo = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 5, 5)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(40, 10, 10)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 5, 5))
            }),
            ["Color Hub 2"] = Color3.fromRGB(20, 5, 5),
            ["Color Stroke"] = Color3.fromRGB(120, 30, 30),
            ["Color Theme"] = Color3.fromRGB(200, 40, 40),
        ...
        DenTim = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 5, 15)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 15, 35)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 5, 15))
            }),
            ["Color Hub 2"] = Color3.fromRGB(20, 10, 20),
            ["Color Stroke"] = Color3.fromRGB(80, 30, 80),
            ["Color Theme"] = Color3.fromRGB(160, 50, 200),
            ["Color Text"] = Color3.fromRGB(230, 200, 255),
            ["Color Dark Text"] = Color3.fromRGB(180, 140, 200)
        },
        ...
        DenXanhLa = {
            ["Color Hub 1"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 35, 15)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(5, 15, 5))
            }),
            ["Color Hub 2"] = Color3.fromRGB(10, 20, 10),
            ["Color Stroke"] = Color3.fromRGB(30, 80, 30),
            ["Color Theme"] = Color3.fromRGB(50, 200, 50),
            ["Color Text"] = Color3.fromRGB(200, 255, 200),
            ["Color Dark Text"] = Color3.fromRGB(140, 200, 140)
        },
        
        -- Theme đen vàng
        DenVang = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 12, 5)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 30, 10)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 12, 5))
            }),
            ["Color Hub 2"] = Color3.fromRGB(20, 17, 7),
            ["Color Stroke"] = Color3.fromRGB(100, 85, 20)),
            ["Color Theme"] = Color3.fromRGB(255, 200, 50),
            ["Color Text"] = Color3.fromRGB(255, 240, 200),
            ["Color Dark Text"] = Color3.fromRGB(200, 180, 120)
        }
    },
	Info = {
		Version = "1.1.0"
	...
	Save = {
		UISize = {550, 380},
		TabSize = 160,
		Theme = "Den"  -- Đã đổi theme mặc định thành Den
	},
	Settings = {},
	Connection = {},
	Instances = {},
