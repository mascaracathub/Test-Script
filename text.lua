...
if not game:IsLoaded() then
	...
	game.Loaded:Wait()
		...
		-- Instances:
local Converted = {
	["_Night Slayer Hub"] = Instance.new("ScreenGui");
...
-- Properties:
Converted["_Night Slayer Hub"].DisplayOrder = 3
Converted["_Night Slayer Hub"].IgnoreGuiInset = true
Converted["_Night Slayer Hub"].ScreenInsets = Enum.ScreenInsets.DeviceSafeInsets
Converted["_Night Slayer Hub"].ResetOnSpawn = false
Converted["_Night Slayer Hub"].ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Converted["_Night Slayer Hub"].Name = "Night Slayer Hub"
Converted["_Night Slayer Hub"].Parent = game:GetService("CoreGui")
Converted["_Open"].Font = Enum.Font.Gotham
Converted["_Open"].Text = "Triple-click this region to open Night Slayer Hub."
...
Converted["_Open"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_DropdownFrameSample"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_ListButton"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Notifications"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_TextBoxPlaceholder"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_FloatingButton"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Dropdown"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_AddCustomModule"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Menu"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_HubName"].Text = "Night Slayer Hub "
...
Converted["_TextLabel7"].Text = "Night Slayer Hub"
...
Converted["_Toggle"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Modules"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_NotificationSample"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Dialog"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_Range"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_FloatingButtonSetting"].Parent = Converted["_Night Slayer Hub"]
...
Converted["_FloatingButtons1"].Parent = Converted["_Night Slayer Hub"]
-- Module Scripts:
local module_scripts = {}
do -- Module: StarterGui.Night Slayer Hub.FUNCTIONS
    local script = Instance.new("ModuleScript")
    script.Name = "FUNCTIONS"
    script.Parent = Converted["_Night Slayer Hub"]
    local function module_script()
		...
		function SBTf()
			...
			-- Implementation by Night Slayer Hub Team, respective credits towards the original creators for spring physics
		...
		local Night Slayer HubPointSave = PointSave.new("Night Slayer Hub")
		...
		function FUNCTIONSmodule.getTheme()
			if getgenv then
				return getgenv().Night Slayer Hub_THEME or FUNCTIONSmodule.theme
			else
		...
		function FUNCTIONSmodule.setTheme(t)
			...
			if getgenv then getgenv().Night Slayer Hub_THEME = t end
		end
		...
		function FUNCTIONSmodule.finetuneFloatingButton(button: TextButton, dragger)
			...
			fBSFResizeDragger.Dragged = function(pos)
				...
				button.Size = newSize
				Night Slayer HubPointSave:set(string.gsub(button.Name, "_", ""), udim2Serializer(button.Position) .. "|" .. udim2Serializer(button.Size) .. "|" .. tostring(button.Visible) .. "|" .. tostring(dragger.CanBeDragged))
			end
		...
		function FUNCTIONSmodule.ftToggleLock()
			...
			Night Slayer HubPointSave:set(string.gsub(getgenv().fBSFRealButton.Name, "_", ""), udim2Serializer(getgenv().fBSFRealButton.Position) .. "|" .. udim2Serializer(getgenv().fBSFRealButton.Size) .. "|" .. tostring(getgenv().fBSFRealButton.Visible) .. "|" .. tostring(getgenv().fBSF_ButtonDragger.CanBeDragged))
		end
		...
		function FUNCTIONSmodule.createFloatingButton(item,button,buttonname,fromload)
			if not getgenv().Night Slayer Hub.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", "")) then
				
				
				local UserInputService = game:GetService("UserInputService")
				if not fromload then
					Night Slayer HubPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(UDim2.fromOffset(125, 90)) .. "|" .. udim2Serializer(UDim2.fromOffset(200,50)) .. "|true|true")
				end
		
				local newFloatingButton = getgenv().Night Slayer Hub.FloatingButton:Clone()
				newFloatingButton.Parent = getgenv().Night Slayer Hub.FloatingButtons
				...
				elseif Night Slayer HubPointSave:get(string.gsub(buttonname, "_", "")) then
					local data = Night Slayer HubPointSave:get(string.gsub(buttonname, "_", "")):split("|")
				...
				floatingButtonDraggers[string.gsub(buttonname, "_", "")].Dragged = function(newPos)
					Night Slayer HubPointSave:set(string.gsub(buttonname, "_", ""), udim2Serializer(newPos) .. "|" .. udim2Serializer(newFloatingButton.Size) .. "|" .. tostring(newFloatingButton.Visible) .. "|" .. tostring(floatingButtonDraggers[string.gsub(buttonname, "_", "")].CanBeDragged))
				end
				...
				Night Slayer HubPointSave:remove(string.gsub(buttonname, "_", ""))
				task.spawn(function()
					local buttontodestroy = getgenv().Night Slayer Hub.FloatingButtons:FindFirstChild(string.gsub(buttonname, "_", ""))
			...
			for _, module in ipairs(getgenv().Modules) do
				for _, item in ipairs(module) do
					if item["Type"] == "Button" then
						...
						local saved = Night Slayer HubPointSave:get(key)
						if saved then
		...
		function FUNCTIONSmodule.loader(module)
			...
			for _, item in ipairs(module) do
				...
				elseif item["Type"] == "Input" then
					local cloneinput = getgenv().Night Slayer Hub.TextBoxPlaceholder:Clone()
				...
				elseif item["Type"] == "Toggle" then
					local clonetoggle = getgenv().Night Slayer Hub.Toggle:Clone()
				...
				elseif item["Type"] == "Dropdown" then	
					local clonedropdown = getgenv().Night Slayer Hub.Dropdown:Clone()
					local dropdownFrame = getgenv().Night Slayer Hub.DropdownFrameSample
				...
				elseif item["Type"] == "Range" then
					local clonerange = getgenv().Night Slayer Hub.Range:Clone()
		...
		function FUNCTIONSmodule.refreshlist()
			...
			for i, module in ipairs(dense) do
				local success, err = pcall(function()
					...
					local listbutton = getgenv().Night Slayer Hub.ListButton:Clone()
				...
				if not success then
					warn(("[Night Slayer Hub] Error loading module %q: %s"):format(module.Name, err))
				end
			end
		end
		...
		getgenv().Night Slayer HubFUNCTIONS = FUNCTIONSmodule
		return FUNCTIONSmodule
		
    end
    module_scripts[script] = module_script
end
do -- Module: StarterGui.Night Slayer Hub.DraggableObject
    local script = Instance.new("ModuleScript")
...
do -- Module: StarterGui.Night Slayer Hub.ClickAndHold
    local script = Instance.new("ModuleScript")
...
do -- Module: StarterGui.Night Slayer Hub.Spring
    local script = Instance.new("ModuleScript")
    script.Name = "Spring"
    script.Parent = Converted["_Night Slayer Hub"]
    local function module_script()
...
do -- Module: StarterGui.Night Slayer Hub.ESPIndicator
    local script = Instance.new("ModuleScript")
    script.Name = "ESPIndicator"
    script.Parent = Converted["_Night Slayer Hub"]
    local function module_script()
		-- Robust ESP module with distancing, arrows, and grouping
		-- Designed and written by Night Slayer Hub
...
do -- Module: StarterGui.Night Slayer Hub.Bezier
    local script = Instance.new("ModuleScript")
    script.Name = "Bezier"
    script.Parent = Converted["_Night Slayer Hub"]
    local function module_script()
...
do -- Module: StarterGui.Night Slayer Hub.PointSave
    local script = Instance.new("ModuleScript")
...
do -- Module: StarterGui.Night Slayer Hub.Theme
    local script = Instance.new("ModuleScript")
    script.Name = "Theme"
    script.Parent = Converted["_Night Slayer Hub"]
    local function module_script()
		-- Beautiful theming module for Night Slayer Hub
		
		local Night Slayer HubRoot = getgenv().Night Slayer Hub
		local api = {
			colors = {
				font = Enum.Font.Montserrat,
				textColor = Color3.fromRGB(255, 255, 255),
...
do -- Module: StarterGui.Night Slayer Hub.FlyUtility
    local script = Instance.new("ModuleScript")
...
local function FKVEADO_routine() -- Script: StarterGui.Night Slayer Hub.Flee the Facility
...
local function KWZT_routine() -- Script: StarterGui.Night Slayer Hub.Universal
    local script = Instance.new("LocalScript")
	...
	--table.insert(module, {
	--	Type = "Text",
	--	Args = {"Welcome to Night Slayer Hub! The open, free script hub."}
	--})
	
	table.insert(module, {
		Type = "Text",
		Args = {"<font color='#FFFF00'>Another great script</font> by Night Slayer Hub developers below!"}
	})
	
	table.insert(module, {
		Type = "Button",
		Args = {"AFEM - A free, FE, simple and easy emotes menu!", function()
			loadstring(game:HttpGet("https://Night Slayer Hub.mhi.im/scr?channel=afem"))()
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Hide Night Slayer Hub", function(Self)
			...
			elseif uis.AccelerometerEnabled then
				...
				fu.notification("Can't hide Night Slayer Hub!") -- how else are you gonna open???
			end
		end,}
	}
	)
	...
	table.insert(module, {
		...
		Args = {"Open developer console (debugging)", function(Self)
			...
			--getgenv().Night Slayer Hub.Open.UIStroke.Transparency = 0
			--getgenv().Night Slayer Hub.Open.TextTransparency = 0
			--ts:Create(getgenv().Night Slayer Hub.Open, TweenInfo.new(1, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
			--	Position = UDim2.fromScale(0.5, 0.903)
			--}):Play()

			--ts:Create(getgenv().Night Slayer Hub.Open.UIStroke, TweenInfo.new(1), {
			--	Transparency = 1
			--}):Play()
			--ts:Create(getgenv().Night Slayer Hub.Open, TweenInfo.new(1), {
			--	TextTransparency = 1
			--}):Play()
		end}
	}
	...
	local function loadThemeFromSave(last)
		...
		if Night Slayer HubPointSave:get("Night Slayer HubGlobal_themeCode") then
			local themeObjectImport = themeDeserialize(https:JSONDecode(fu.from_base64(Night Slayer HubPointSave:get("Night Slayer HubGlobal_themeCode"))))
			theme:setColorTable(themeObjectImport)
			theme:init(getgenv().Night Slayer Hub)
	...
	table.insert(module, {
		...
		Args = {
			...
			function(obj, value)
				...
				Night Slayer HubPointSave:set("Night Slayer HubGlobal_themeCode", value)
			end
		}
	})
	...
	table.insert(module, {
		...
		Args = {"Delete theme from save", function()
			Night Slayer HubPointSave:remove("Night Slayer HubGlobal_themeCode")
	...
	task.spawn(function()
		local success, titles = pcall(function()
			return https:JSONDecode(game:HttpGet("https://Night Slayer Hub.mhi.im/static/ingametitles.json"))
		end)
	...
	table.insert(module, {
		Type = "Toggle",
		Args = {"Hide Night Slayer Hub+/Developer tags", function(_, state)
	...
	table.insert(module, {
		Type = "Dropdown",
		Args = {"how rizz is Night Slayer Hub", {"very rizz", "no rizz"}, function(Self, item)
			print(item)
		end,}
	})
...
local function JPYMZP_routine() -- Script: StarterGui.Night Slayer Hub.Init
	local script = Instance.new("LocalScript")
	script.Name = "Init"
	script.Parent = Converted["_Night Slayer Hub"]
	local req = require
	...
	getgenv().Night Slayer Hub = script.Parent
	...
	local s, e = pcall(function()
		if get_hidden_gui or gethui then
			...
			--print("[Night Slayer Hub] - Using get_hidden_gui for anti-detection.")
		elseif (not is_sirhurt_closure) and (syn and syn.protect_gui) then
			script.Parent.Name = randomString()
			syn.protect_gui(script.Parent)
			script.Parent.Parent = COREGUI
			--print("[Night Slayer Hub] - Using syn.protect_gui for anti-detection.")
		elseif COREGUI:FindFirstChild('RobloxGui') then
			script.Parent.Parent = COREGUI.RobloxGui
			--print("[Night Slayer Hub] - Using RobloxGui for anti-detection.")
		else
			--warn("[Night Slayer Hub] - Using CoreGui as anti-detection. This is the most basic coverage and can still be detected.")
		end
	end)

	--print("[Night Slayer Hub] - Night Slayer Hub is now in " .. tostring(script.Parent:GetFullName()))
	if not s then
		--warn("[Night Slayer Hub] - Attempts at anti-detection failed. Using CoreGui as anti-detection.")
		warn(e)	
	end

	--printidentity("[Night Slayer Hub] - Your executor level (identity) is")

	local getExeName = identifyexecutor or getexecutorname or function() return "Yet Another Roblox Executor v1.2" end
	--print("[Night Slayer Hub] - Your executor is " .. getExeName())
	...
	--require(script.Parent.FUNCTIONS).notification("Welcome to Night Slayer Hub Nebula.")
	...
	--require(script.Parent.Theme):init(getgenv().Night Slayer Hub)
...
local function ZUTHJ_routine() -- Script: StarterGui.Night Slayer Hub.Forsaken
	local script = Instance.new("LocalScript")
	...
	local fu = require(getgenv().Night Slayer Hub.FUNCTIONS)
	if (module.gameId ~= game.GameId) then
		table.insert(module, {
			Type = "Text",
			Args = {"Night Slayer Hub now includes an official <font color='#FFFF00'>Forsaken</font> module!"}
		})
		table.insert(module, {
			Type = "Text",
			Args = {"<font size='10'>To use, run Night Slayer Hub on Forsaken.</font>"}
		})
		repeat task.wait() until getgenv().Modules
...
local function IJIOJM_routine() -- Script: StarterGui.Night Slayer Hub.Murder Mystery 2
	local script = Instance.new("LocalScript")
	...
	workspace.DescendantRemoving:Connect(function(ch)
		if gunDropESP and ch.Name == "GunDrop" then
			...
			--					mbgui.Parent = getgenv().Night Slayer Hub
	...
	local function getPredictedPosition(player, shootOffset)
		...
		if predictionAIEngine and not usingBasicPred and not predictionCooldown and getgenv().Night Slayer HubNetwork_predictPos then
			if (playerPosition - localplayer.Character:FindFirstChild("UpperTorso").Position).Magnitude > 20 then
				...
				local predictedPosition = getgenv().Night Slayer HubNetwork_predictPos(ogplayer)
		...
		elseif predictionAIEngine and not getgenv().Night Slayer HubNetwork.predictPos then
			fu.notification("Night Slayer Hub AI Engine is not available. Reverting to basic prediction.")	
		end
			...
			Auto_Shoot_murderer = function()
				...
				if findSheriff() == localplayer and autoShooting then
					...
					repeat
						task.wait(0.1)
						local murderer = findMurderer() or findSheriffThatsNotMe()
						if not murderer then warn("[Night Slayer Hub] > MM2 Autoshoot - No murderer.") continue end
						local murdererPosition = murderer.Character.HumanoidRootPart.Position
						local characterRootPart = localplayer.Character.HumanoidRootPart
	...
	table.insert(module, {
		...
		Sheriff: %s |
		<<Night Slayer Hub>>]], murdName, sherName)
...
local function YDDXFM_routine() -- Script: StarterGui.Night Slayer Hub.Open.InitOpen
	local script = Instance.new("LocalScript")
...
local function YYXOT_routine() -- Script: StarterGui.Night Slayer Hub.Open.OnClick
	local script = Instance.new("LocalScript")
	script.Name = "OnClick"
	script.Parent = Converted["_Open"]
	local req = require
	...
	script.Parent.MouseButton1Click:Connect(function()
		...
		if clickCount == 3 then
			...
			ts:Create(getgenv().Night Slayer Hub.Menu, TweenInfo.new(0.7, Enum.EasingStyle.Back, Enum.EasingDirection.Out), 
...
local function EDMIQL_routine() -- Script: StarterGui.Night Slayer Hub.Open.Resizer
	local script = Instance.new("LocalScript")
	script.Name = "Resizer"
	script.Parent = Converted["_Open"]
	local req = require
...
local function SSZQIL_routine() -- Script: StarterGui.Night Slayer Hub.FloatingButton.Keybinding
	local script = Instance.new("LocalScript")
...
local function PGWO_routine() -- Script: StarterGui.Night Slayer Hub.FloatingButton.Invisible
	local script = Instance.new("LocalScript")
...
local function CSJOXT_routine() -- Script: StarterGui.Night Slayer Hub.AddCustomModule.Add.LocalScript
	local script = Instance.new("LocalScript")
	...
	task.wait(1.5)
	if game.gameId == 5794311181 then loadModule("https://Night Slayer Hub.mhi.im/static/cnasim.yrmdl") end -- CNA Simulator
end
local function PDCOB_routine() -- Script: StarterGui.Night Slayer Hub.AddCustomModule.Cancel.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function TYNISV_routine() -- Script: StarterGui.Night Slayer Hub.Menu.UIStroke.UIGradient.Animator
	local script = Instance.new("LocalScript")
...
local function GRBP_routine() -- Script: StarterGui.Night Slayer Hub.Menu.CloseArea.CloseOpen
	local script = Instance.new("LocalScript")
...
local function WAVF_routine() -- Script: StarterGui.NIGHTSLAYERHUB.Menu.List.AutoSetup
	local script = Instance.new("LocalScript")
...
local function NPAX_routine() -- Script: StarterGui.NIGHTSLAYERHUB.Menu.List.AddCustomModule.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function QXNY_routine() -- Script: StarterGui.NIGHTSLAYERHUB.FloatingButtonSetting.ControlBarContainer.ControlBar.Visibility.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().NIGHTSLAYERHUBFUNCTIONS.ftToggleVisibility()
	end)
end
local function OLQBK_routine() -- Script: StarterGui.NIGHTSLAYERHUB.FloatingButtonSetting.ControlBarContainer.ControlBar.Lock.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().NIGHTSLAYERHUBFUNCTIONS.ftToggleLock()
	end)
end
local function QUDG_routine() -- Script: StarterGui.NIGHTSLAYERHUB.FloatingButtonSetting.ControlBarContainer.ControlBar.Exit.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
	...
	script.Parent.MouseButton1Click:Connect(function()
		getgenv().NIGHTSLAYERHUBFUNCTIONS.closeFinetuneFB()
	end)
end
